    ...
    <footer>
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h3>Kontak Kami</h3>
                    <p><i class="fas fa-map-marker-alt"></i> Jl. Raya Karang Bayan,Lingsar, Lombok Barat, NTB</p>
                    <p><i class="fas fa-phone"></i> 087865586338</p>
                ...
                <div class="footer-section">
                    ...
                    <a href="konten.php">Galeri Foto</a>
